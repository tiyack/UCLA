...
int main(){
   //declaring
    string name, job;
    int child;
    double rest; //declared rest as a fucking int and not double
    double income, tax; //dumb dumb dumb dumb
    ...
    if(income <= 0){ //once again dumb included 0
        cout << "---" << endl;
    ...
    if(child <= 0){ //fucking stupid included 0//lost more than 27 here
        cout << "---" << endl;
