...
private:
    virtual bool activateOnPass() {return false;}
...
{
public:
    CoinSquare(StudentWorld* sw, int imageID, int startX, int startY);
    ~CoinSquare() {} //Destructor
...
public:
    ...
    ~StarSquare() {} //Destructor
    
private:
    bool activateOnPass() {return true;}
};
