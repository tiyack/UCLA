...
//    if ((newX / SPRITE_WIDTH > BOARD_WIDTH) || (newY / SPRITE_HEIGHT > BOARD_HEIGHT)
//        || (newX / SPRITE_WIDTH < 0) || (newY / SPRITE_HEIGHT < 0))
//    {
//        cerr << "Cant move in " << dir << endl;
//        return false;
//    }
    if (!getWorld()->squareExists(dir, newX, newY))
        return false;
    return true;
}
